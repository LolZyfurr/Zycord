(async function() {
    ...
    let CHANGELOG_DATA = [{
        DATA_MESSAGE: "Created a separate module for the leaderboard.",
        DATA_TIME: "24.5.6.11.0.5"
    }, {
    ...
    async function fetchLeaderboard(button, today) {
        let url = 'https://raw.githubusercontent.com/Zy1ux/Zycord/main/Modules/Leaderboard.js';
        fetch(url)
