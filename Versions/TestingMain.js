(async function() {
    function checkValueExists(ValueToCheck, ElseValue) {
        return ValueToCheck ? ValueToCheck : ElseValue ? ElseValue : null;
    }

    function checkValuesExist(FirstValueToCheck, SecondValueToCheck, ElseValue) {
    ...
    let APP_VERSION = `TESTING ${DATE_UPDATED}`
